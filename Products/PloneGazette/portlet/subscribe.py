...
class ISubscribeNewsletterForm(Schema):
    ...
    gdpr = schema.Bool(
        ...
        description=_(u'En cochant la case, vous acceptez que les informations que vous fournissez seront trait&eacute;es conformément &agrave; notre <a href="gdpr-view">politique de confidentialit&eacute;</a>'),
        default=False,
        required=True
    )
